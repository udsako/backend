 ...
 * @author HP
 */
public class horticulture extends javax.swing.JFrame {
...
private String currentStaffID;
    ...
    public horticulture(String staffID, String unitName, boolean isSupervisor) {
...
//    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("HORTICULTURE STAFF");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(440, 509, Short.MAX_VALUE))
        );
...
try (Connection conn = DriverManager.getConnection(
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(horticulture.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            boolean isSupervisor = true;
                new horticulture(staffID, unit, isSupervisor).setVisible(true);
            }
        });
    }
